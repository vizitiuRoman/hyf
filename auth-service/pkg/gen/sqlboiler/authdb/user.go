...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "authservicedb: failed to execute a one query for user")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "authservicedb: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: failed to count user rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "authservicedb: failed to check if user exists")
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "authservicedb: unable to select from user")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("authservicedb: no user provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "authservicedb: unable to insert into user")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("authservicedb: unable to update user, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to update user row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: failed to get rows affected by update for user")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to update all for user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to retrieve rows affected for user")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("authservicedb: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("authservicedb: no user provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("authservicedb: unable to upsert user, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "authservicedb: unable to upsert user")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("authservicedb: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to delete from user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: failed to get rows affected by delete for user")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("authservicedb: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to delete all from user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: failed to get rows affected by deleteall for user")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "authservicedb: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "authservicedb: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "authservicedb: unable to check if user exists")
	}
