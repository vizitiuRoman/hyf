...
func NewAuthInterceptor(_ context.Context, rdb redis.Cache, authTokenRepoFactory repo.AuthTokenRepoFactory, authTokenAdapterFactory adapter.AuthTokenAdapterFactory) grpc.UnaryServerInterceptor {
	return func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (resp interface{}, err error) {
		...
		default:
			...
			authTokenAdapter := authTokenAdapterFactory.Create(ctx)

			uuidClaim, _, err := authTokenAdapter.ClaimsFromJWT(ctx, token)
			if err != nil {
