...
func (c *ratingSVCClient) GetRatings(ctx context.Context, in *GetRatingsIn, opts ...grpc.CallOption) (*GetRatingsOut, error) {
	...
	err := c.cc.Invoke(ctx, RatingSVC_GetRatings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ratingSVCClient) GetRating(ctx context.Context, in *GetRatingIn, opts ...grpc.CallOption) (*GetRatingOut, error) {
	...
	err := c.cc.Invoke(ctx, RatingSVC_GetRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ratingSVCClient) CreateRating(ctx context.Context, in *CreateRatingIn, opts ...grpc.CallOption) (*CreateRatingOut, error) {
	...
	err := c.cc.Invoke(ctx, RatingSVC_CreateRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ratingSVCClient) UpdateRating(ctx context.Context, in *UpdateRatingIn, opts ...grpc.CallOption) (*UpdateRatingOut, error) {
	...
	err := c.cc.Invoke(ctx, RatingSVC_UpdateRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ratingSVCClient) DeleteRating(ctx context.Context, in *DeleteRatingIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, RatingSVC_DeleteRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRatingSVCServer must be embedded to have forward compatible implementations.
...
// UnsafeRatingSVCServer may be embedded to opt out of forward compatibility for this service.
