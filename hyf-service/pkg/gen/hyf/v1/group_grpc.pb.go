...
func (c *groupSVCClient) GetGroups(ctx context.Context, in *GetGroupsIn, opts ...grpc.CallOption) (*GetGroupsOut, error) {
	...
	err := c.cc.Invoke(ctx, GroupSVC_GetGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupSVCClient) GetGroup(ctx context.Context, in *GetGroupIn, opts ...grpc.CallOption) (*GetGroupOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGroupOut)
	err := c.cc.Invoke(ctx, GroupSVC_GetGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupSVCClient) CreateGroup(ctx context.Context, in *CreateGroupIn, opts ...grpc.CallOption) (*CreateGroupOut, error) {
	...
	err := c.cc.Invoke(ctx, GroupSVC_CreateGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupSVCClient) UpdateGroup(ctx context.Context, in *UpdateGroupIn, opts ...grpc.CallOption) (*UpdateGroupOut, error) {
	...
	err := c.cc.Invoke(ctx, GroupSVC_UpdateGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupSVCClient) DeleteGroup(ctx context.Context, in *DeleteGroupIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, GroupSVC_DeleteGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGroupSVCServer must hyf-service embedded to have
...
// UnsafeGroupSVCServer may hyf-service embedded to opt out of forward compatibility for this service.
...
func RegisterGroupSVCServer(s grpc.ServiceRegistrar, srv GroupSVCServer) {
	// If the following call pancis, it indicates UnimplementedGroupSVCServer was
